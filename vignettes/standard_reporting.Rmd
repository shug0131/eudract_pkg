...
```{r dotplot_sae, fig.cap="SAE", fig.height=8, fig.width=8, out.width="90%",eval=FALSE}
...
```{r dotplot_ae, fig.cap="Non-Serious AE", fig.height=8, fig.width=8,
out.width="90%", eval=FALSE}
...
```{r dotplot_edit, fig.height=8, fig.width=8, out.width="90%", eval=FALSE}
